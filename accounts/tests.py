...
class RegistrationTests(TestCase):
    ...
    def test_registration_success_url(self):
        ...
        user = User.objects.get(email='foobar@foobar.com')
    ...
    def test_valid_activation(self):
        ...
        user = User.objects.get(email='foofoo@barbar.com')
    ...
    def test_invalid_activation_key(self):
        ...
        self.assertFalse(user.is_active)
        self.assertEqual(response.status_code, 200)
        self.assertTemplateUsed('accounts/activate.html')
